...
class StatesControllerTest < ActionController::TestCase
  ...
  test "should create state" do
    assert_difference('State.count') do
      post :create, state: { capital: @state.capital, cities: @state.cities, language: @state.language, size: @state.size }
    end
  ...
  test "should update state" do
    put :update, id: @state, state: { capital: @state.capital, cities: @state.cities, language: @state.language, size: @state.size }
    assert_redirected_to state_path(assigns(:state))
  end
